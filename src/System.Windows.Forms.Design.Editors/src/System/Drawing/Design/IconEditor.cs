...
namespace System.Drawing.Design
{
    ...
    {
        protected static List<string> s_iconExtensions = new List<string>() { "ico" };

        internal static Type[] _imageExtenders = Array.Empty<Type>();
        internal FileDialog _fileDialog;
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (_fileDialog == null)
            {
                ...
                Debug.Assert(_imageExtenders.Length <= 0, "Why does IconEditor have subclasses if Icon doesn't?");
